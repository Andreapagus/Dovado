...
public class Main {
	...
	public static void main(String[] args) {
		...
		if(cf.findActivityByID(p,8).playableOnThisDate(LocalDateTime.of(LocalDate.of(2021, 1,12), LocalTime.of(19, 17)))) System.out.println("√® fattibile :)\n");
		...
		if(cf.findActivityByID(p,9).playableOnThisDate(LocalDateTime.of(LocalDate.of(2021, 1,12), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
		...
		if(cf.findActivityByID(p,9).playableOnThisDate(LocalDateTime.of(LocalDate.of(2021, 1,13), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
		...
		if(cf.findActivityByID(p,9).playableOnThisDate(LocalDateTime.of(LocalDate.of(2021, 6,15), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
		...
		if(cf.findActivityByID(p,10).playableOnThisDate(LocalDateTime.of(LocalDate.of(2021, 6,15), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
		...
		if(cf.findActivityByID(p,10).playableOnThisDate(LocalDateTime.of(LocalDate.of(2021, 6,17), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
		...
		if(cf.findActivityByID(p,11).playableOnThisDate(LocalDateTime.of(LocalDate.of(2021, 6,17), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
		...
		if(cf.findActivityByID(p,11).playableOnThisDate(LocalDateTime.of(LocalDate.of(2022, 1,13), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
		...
		if(cf.findActivityByID(p,12).playableOnThisDate(LocalDateTime.of(LocalDate.of(2022, 1,13), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
		...
		if(cf.findActivityByID(p,12).playableOnThisDate(LocalDateTime.of(LocalDate.of(2021, 1,19), LocalTime.of(10, 17)))) System.out.println("Ë fattibile :)\n");
		else System.out.println("non Ë fattibile :(\n");
		//--------------------------------------------------------------
